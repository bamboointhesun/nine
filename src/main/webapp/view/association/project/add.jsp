...
<body>
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item btn btn-info disabled">在这里添加新的活动</li>
			</ul>
		</div>
		</nav>
		<form action="<%=basePath%>project/add.do" method="post">
			<table class="table table-bordered text-center bg-light text-dark">
				...
				<tr>
					<td>活动主题</td>
					<td><input type="text" name="projectTopic" placeholder="尽量简洁" class="form-control"></td>
				</tr>
				<tr>
					<td>活动地点</td>
					<td><input type="text" name="projectPlace" class="form-control"></td>
				</tr>
				<tr>
					<td>活动负责人</td>
					<td><input type="text" name="projectWheel" class="form-control"></td>
				</tr>
				<tr>
					<td>活动赞助商</td>
				...
				<tr>
					<td>开始时间</td>
					<td><input type="date" name="startTime" class="form-control"></td>
				</tr>
				<tr>
					<td>结束时间</td>
					<td><input type="date" name="endTime" class="form-control"></td>
				</tr>
				<tr>
					<td>想好了</td>
