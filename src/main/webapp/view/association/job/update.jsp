	...
	<div class="container-fluid">
		...
		<form action="<%=basePath%>job/update.do" method="post">
			...
			<table class="table table-bordered text-center bg-light text-dark">
				<tr>
					<td>职务</td>
					<td><input type="text" value="${job.jobTitle}" name="jobTitle"
						class="form-control"></td>
				</tr>
				<tr>
					<td>描述</td>
					<td><textarea class="form-control" placeholder="尽量精炼" rows="5"
							id="comment" name="jobDesc" class="form-control">${job.jobDesc}</textarea></td>
				</tr>
				<tr>
					<td>添加时间</td>
				...
				<tr>
					<td>上次修改时间</td>
					<td><fmt:formatDate value="${job.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				</tr>
				<tr>
					<td>想好了</td>
