...
<body>
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item btn btn-info disabled">职务列表展示</li>
			</ul>
		</div>
		</nav>
		<table class="table table-bordered text-center bg-light text-dark">
			<tr>
				<td class="text-left" colspan="5"><a
					href="<%=basePath%>job/addUI.do?" class="btn btn-primary btn-sm">添加</a></td>
			</tr>
			<tr>
				<td>职务</td>
				<td>描述</td>
			...
			<td>${job.jobTitle }</td>
			<td>${job.jobDesc }</td>
			<td><a href="<%=basePath%>job/delete.do?jobId=${job.jobId }"
				class="btn btn-primary btn-sm alert alert-danger">删除</a> <a
				href="<%=basePath%>job/updateUI.do?jobId=${job.jobId }"
