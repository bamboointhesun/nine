...
<body>
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item btn btn-info disabled">在这里添加新的职务</li>
			</ul>
		</div>
		</nav>
		<form action="<%=basePath%>job/add.do" method="post">
			<table class="table table-bordered text-center bg-light text-dark">
				...
				<tr>
					<td>描述</td>
					<td><textarea class="form-control" placeholder="尽量精炼"
							rows="5" id="comment" name="jobDesc" class="form-control"></textarea></td>
				</tr>
				<tr>
				<tr>
					<td>想好了</td>
